...
from homeassistant.const import (
    CONF_LATITUDE, CONF_LONGITUDE, CONF_ELEVATION, CONF_NAME, CONF_TEMPERATURE_UNIT,
...
DEFAULT_CONFIG = (
    ...
    (CONF_ELEVATION, None, 'elevation', 'Elevation of location.'),
